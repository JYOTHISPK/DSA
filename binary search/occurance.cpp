/*
--------------------------------------------
Problem     : Find First And Last Occurance Of An Element
              In A Sorted Array.
...
Description : Given an array of integers arr which is sorted in
              ...
              to find first and last occurance of target in the array.
...
int main(){
    ...
    if(ans==n || arr[ans]!=target){
        cout << "first and last occurance is (-1,-1)";
    }
    else{
        cout << "first and last occurance is " << ans << " , " << ans1-1;
    }
}